...
# Awesome asyncio [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,154 | 🐛 68 | 📅 2026-01-28 with stars
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 94,920 | 🐛 167 | 🌐 Python | 📅 2026-02-08 - A very high performance Python 3.6+ API framework based on type hints. Powered by Starlette and Pydantic.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,637 | 🐛 117 | 🌐 Python | 📅 2026-01-07 - Python 3.5+ web server that's written to go fast.
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,256 | 🐛 284 | 🌐 Python | 📅 2026-02-07 - Http client/server for asyncio (PEP-3156).
* [Starlette](https://github.com/encode/starlette) ⭐ 11,903 | 🐛 54 | 🌐 Python | 📅 2026-02-01 - A lightweight ASGI framework/toolkit for building high performance services.
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,376 | 🐛 83 | 🌐 Python | 📅 2026-02-02 - The lightning-fast ASGI server.
...
* [aiokafka](https://github.com/aio-libs/aiokafka) ⭐ 1,363 | 🐛 185 | 🌐 Python | 📅 2026-01-31 - Client for Apache Kafka.
* [asyncio-nats](https://github.com/nats-io/asyncio-nats) ⭐ 1,183 | 🐛 198 | 🌐 Python | 📅 2026-02-05 - Client for the NATS messaging system.
...
* [redis-py](https://github.com/redis/redis-py) ⭐ 13,467 | 🐛 108 | 🌐 Python | 📅 2026-02-07 - Redis Python Client (which includes [aioreadis](https://github.com/aio-libs/aioredis) ⚠️ Archived now).
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,928 | 🐛 261 | 🌐 Python | 📅 2025-11-24 - Fast PostgreSQL Database Client Library for Python/asyncio.
* [Tortoise ORM](https://github.com/tortoise/tortoise-orm) ⭐ 5,477 | 🐛 488 | 🌐 Python | 📅 2026-02-08 - native multi-backend ORM with Django-like API and easy relations management.
...
* [GINO](https://github.com/fantix/gino) ⭐ 2,812 | 🐛 55 | 🌐 Python | 📅 2022-02-12 - is a lightweight asynchronous Python ORM based on [SQLAlchemy](https://www.sqlalchemy.org/) core, with [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 7,928 | 🐛 261 | 🌐 Python | 📅 2025-11-24 dialect.
...
* [aiomysql](https://github.com/aio-libs/aiomysql) ⭐ 1,886 | 🐛 111 | 🌐 Python | 📅 2026-01-22 - Library for accessing a MySQL database
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,854 | 🐛 61 | 🌐 Python | 📅 2026-02-06 - An ORM / query builder which can work in async and sync modes, with a nice admin GUI, and ASGI middleware.
* [aiopg](https://github.com/aio-libs/aiopg/) ⭐ 1,426 | 🐛 87 | 🌐 Python | 📅 2025-12-03 - Library for accessing a PostgreSQL database.
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 765 | 🐛 9 | 🌐 Python | 📅 2025-11-19 - ORM implementation based on [peewee](https://github.com/coleifer/peewee) ⭐ 11,927 | 🐛 0 | 🌐 Python | 📅 2026-02-09 and aiopg.
...
* [httpx](https://github.com/encode/httpx) ⭐ 14,972 | 🐛 134 | 🌐 Python | 📅 2026-02-01 - asynchronous HTTP client for Python 3 with [requests](https://github.com/psf/requests) ⭐ 53,720 | 🐛 329 | 🌐 Python | 📅 2026-02-06 compatible API.
...
* [pytest-asyncio](https://github.com/pytest-dev/pytest-asyncio) ⭐ 1,614 | 🐛 57 | 🌐 Python | 📅 2026-02-03 - Pytest support for asyncio.
...
* [aresponses](https://github.com/CircleUp/aresponses) ⭐ 107 | 🐛 4 | 🌐 Python | 📅 2024-07-11 - Asyncio http mocking. Similar to the [responses](https://github.com/getsentry/responses) ⭐ 4,318 | 🐛 36 | 🌐 Python | 📅 2026-01-20 library used for [requests](https://github.com/requests/requests) ⭐ 53,720 | 🐛 329 | 🌐 Python | 📅 2026-02-06.
...
* [aioserial](https://github.com/changyuheng/aioserial) ⭐ 146 | 🐛 14 | 🌐 Python | 📅 2022-07-25 - A drop-in replacement of [pySerial](https://github.com/pyserial/pyserial) ⭐ 3,497 | 🐛 336 | 🌐 Python | 📅 2026-01-08.
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,159 | 🐛 316 | 🌐 Python | 📅 2026-02-01 - Pythonic async I/O for humans and snake people.
...
* [AnyIO](https://github.com/agronholm/anyio) ⭐ 2,380 | 🐛 75 | 🌐 Python | 📅 2026-02-08 - High level asynchronous concurrency and networking framework that works on top of either trio or asyncio.
