...
# Awesome asyncio [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,589 | 🐛 68 | 📅 2026-01-28 with stars
...
* [FastAPI](https://github.com/tiangolo/fastapi) ⭐ 94,993 | 🐛 158 | 🌐 Python | 📅 2026-02-11 - A very high performance Python 3.6+ API framework based on type hints. Powered by Starlette and Pydantic.
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,640 | 🐛 119 | 🌐 Python | 📅 2026-01-07 - Python 3.5+ web server that's written to go fast.
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,259 | 🐛 287 | 🌐 Python | 📅 2026-02-11 - Http client/server for asyncio (PEP-3156).
* [Starlette](https://github.com/encode/starlette) ⭐ 11,911 | 🐛 56 | 🌐 Python | 📅 2026-02-11 - A lightweight ASGI framework/toolkit for building high performance services.
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,379 | 🐛 84 | 🌐 Python | 📅 2026-02-02 - The lightning-fast ASGI server.
* [websockets](https://github.com/aaugustin/websockets/) ⭐ 5,630 | 🐛 20 | 🌐 Python | 📅 2026-01-16 - A library for building WebSocket servers and clients in Python with a focus on correctness and simplicity.
* [Quart](https://github.com/pallets/quart) ⭐ 3,593 | 🐛 66 | 🌐 Python | 📅 2025-09-01 - An asyncio web microframework with the same API as Flask.
...
* [pyzmq](https://github.com/zeromq/pyzmq) ⭐ 4,091 | 🐛 53 | 🌐 Python | 📅 2026-02-02 - Python bindings for ZeroMQ.
...
* [asyncio-nats](https://github.com/nats-io/asyncio-nats) ⭐ 1,187 | 🐛 197 | 🌐 Python | 📅 2026-02-10 - Client for the NATS messaging system.
...
* [redis-py](https://github.com/redis/redis-py) ⭐ 13,470 | 🐛 110 | 🌐 Python | 📅 2026-02-10 - Redis Python Client (which includes [aioreadis](https://github.com/aio-libs/aioredis) ⚠️ Archived now).
...
* [Tortoise ORM](https://github.com/tortoise/tortoise-orm) ⭐ 5,489 | 🐛 484 | 🌐 Python | 📅 2026-02-11 - native multi-backend ORM with Django-like API and easy relations management.
* [pymongo](https://github.com/mongodb/mongo-python-driver) ⭐ 4,333 | 🐛 7 | 🌐 Python | 📅 2026-02-10 - The Official MongoDB Python driver, offering both synchronous and asynchronous APIs.
* [Beanie](https://beanie-odm.dev) - An async MongoDB ODM built on [pymongo](https://github.com/mongodb/mongo-python-driver) ⭐ 4,333 | 🐛 7 | 🌐 Python | 📅 2026-02-10 and [Pydantic](https://pydantic-docs.helpmanual.io).
...
* [Piccolo](https://github.com/piccolo-orm/piccolo) ⭐ 1,855 | 🐛 62 | 🌐 Python | 📅 2026-02-11 - An ORM / query builder which can work in async and sync modes, with a nice admin GUI, and ASGI middleware.
* [aiopg](https://github.com/aio-libs/aiopg/) ⭐ 1,427 | 🐛 87 | 🌐 Python | 📅 2025-12-03 - Library for accessing a PostgreSQL database.
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 765 | 🐛 9 | 🌐 Python | 📅 2025-11-19 - ORM implementation based on [peewee](https://github.com/coleifer/peewee) ⭐ 11,932 | 🐛 0 | 🌐 Python | 📅 2026-02-10 and aiopg.
...
* [httpx](https://github.com/encode/httpx) ⭐ 14,978 | 🐛 135 | 🌐 Python | 📅 2026-02-11 - asynchronous HTTP client for Python 3 with [requests](https://github.com/psf/requests) ⭐ 53,728 | 🐛 327 | 🌐 Python | 📅 2026-02-11 compatible API.
* [AsyncSSH](https://github.com/ronf/asyncssh) ⭐ 1,712 | 🐛 6 | 🌐 Python | 📅 2026-02-07 - Provides an asynchronous client and server implementation of the SSHv2 protocol.
...
* [aresponses](https://github.com/CircleUp/aresponses) ⭐ 107 | 🐛 4 | 🌐 Python | 📅 2024-07-11 - Asyncio http mocking. Similar to the [responses](https://github.com/getsentry/responses) ⭐ 4,319 | 🐛 36 | 🌐 Python | 📅 2026-01-20 library used for [requests](https://github.com/requests/requests) ⭐ 53,728 | 🐛 327 | 🌐 Python | 📅 2026-02-11.
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,639 | 🐛 149 | 🌐 Cython | 📅 2026-01-30 - Ultra fast implementation of asyncio event loop on top of libuv.
...
* [kubernetes\_asyncio](https://github.com/tomplus/kubernetes_asyncio) ⭐ 426 | 🐛 21 | 🌐 Python | 📅 2026-02-10 - Asynchronous client library for Kubernetes.
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,161 | 🐛 317 | 🌐 Python | 📅 2026-02-10 - Pythonic async I/O for humans and snake people.
...
* [AnyIO](https://github.com/agronholm/anyio) ⭐ 2,382 | 🐛 74 | 🌐 Python | 📅 2026-02-09 - High level asynchronous concurrency and networking framework that works on top of either trio or asyncio.
